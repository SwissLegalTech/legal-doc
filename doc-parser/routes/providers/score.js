	...
	sentences: [
		{
			text: {
				content:
					'Wir schätzen Frau Maria De Bon als sehr pflichtbewusste, vertrauenswürdige und einsatzfreudige Mitarbeiterin.',
				beginOffset: 0,
			},
			sentiment: {
		...
		},
		{
			text: {
				content:
					'Sie arbeitete sich dank ihrer sehr guten Auffassungsgabe sehr schnell in ihr vielfältiges Arbeitsgebiet ein.',
				beginOffset: 110,
			},
			sentiment: {
				magnitude: 0.8999999761581421,
		...
		},
		{
			text: {
				content:
					'Wir lernten sie als einsatzbereite, zuverlässige und pflichtbewusste Teamkollegin kennen.',
				beginOffset: 219,
			},
			sentiment: {
				magnitude: 0.8999999761581421,
		...
		},
		{
			text: {
				content:
					'Sie erledigte ihre Aufgaben speditiv und stets zu unserer vollsten Zufriedenheit.',
				beginOffset: 309,
			},
			sentiment: {
				magnitude: 0.8999999761581421,
		...
		},
		{
			text: {
				content:
					'Ihre guten Französisch und Englischkenntnisse kamen auf der Geschäftsstelle bestens zum Tragen.',
				beginOffset: 391,
			},
			sentiment: {
				magnitude: 0.8999999761581421,
